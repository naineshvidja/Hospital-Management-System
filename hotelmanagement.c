...
void insertnormalpatient_()
{
 ...
 printf("1-General Physician MD-Dr.Neha\n");
 printf("2-Orthopaedician-Dr.Hada\n");
 printf("3-Paediatrician-Dr.Saraswati\n");
 printf("4-Opthalmologist-Dr.Salim\n");
 printf("5-Dermatologist-Dr.Rekha\n");
 printf("6-Radiologist-Dr.Malek\n");
 printf("7-Pathologist-Dr.Subhash\n");
 printf("8-Urologist-Dr.Umesh\n\n");
